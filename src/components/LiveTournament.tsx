...
const LiveTournament = ({ onSessionAdded }: LiveTournamentProps) => {
  ...
  const economics = useMemo(() => {
    ...
    const playersInMoney = activeTournament.total_players ? Math.ceil((activeTournament.total_players * percentPaid) / 100) : 0;
